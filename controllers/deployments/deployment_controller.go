...
//+kubebuilder:rbac:groups=deployments.etz.com,resources=deployments,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=deployments.etz.com,resources=deployments/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=deployments.etz.com,resources=deployments/finalizers,verbs=update
